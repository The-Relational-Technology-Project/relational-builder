...
const DISTILLER_SYSTEM = [
  ...
  '',
  'Place-rooting: this prompt will travel to OTHER neighborhoods. Write the prompt itself in clean, complete sentences with NO bracketed placeholders inside them — where the app references a specific place, group, or event, say it generically ("the neighborhood", "the weekly gathering"). Then END the prompt with this line on its own:',
  'To make it yours, answer these:',
  'followed by 3-5 questions, one per line, each wrapped in square brackets — the things most likely to differ from place to place: which neighborhood or community it serves, the specific event, space, or ritual involved, local names or categories, who stewards it. Example: "[What neighborhood or community is this for?]". The prompt should invite adaptation, not read like a form.',
  '',
...
const STARTER_SYSTEM = [
  ...
  '',
  'Place-rooting: this will travel to OTHER neighborhoods. Write the prompt itself in clean, complete sentences with NO bracketed placeholders inside them — where the tool references a specific place, group, or event, say it generically ("the neighborhood", "the weekly gathering"). Then END the prompt with this line on its own:',
  'To make it yours, answer these:',
  'followed by 3-5 questions, one per line, each wrapped in square brackets — the things most likely to differ from place to place: which neighborhood or community it serves, the specific event, space, or ritual involved, local names or categories, who stewards it. Example: "[What neighborhood or community is this for?]".',
  '',
