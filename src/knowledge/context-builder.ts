...
const BASE_INSTRUCTIONS = [
  ...
  '- **Simple tools** (boards, calendars, signups, info pages): plain HTML/CSS/JS, often a single index.html. Fastest to preview, easiest to host and remix — the default unless there is a reason otherwise.',
  '- **Richer interactivity** (lots of shared state, many views, drag-and-drop, complex forms): React (.jsx or .tsx files) — the preview bundles it automatically. Use function components and hooks; add small, well-known packages only when they truly earn their weight.',
...
const PLAN_INSTRUCTIONS = [
  ...
  '',
  'Invite visual guidance early: if the person hasn\'t attached an image yet, encourage it once, warmly — a screenshot of something they love, local art, a photo of their place, a mood board (attached with the image button). Real visual references shape a far better design than adjectives, and they make the tool feel like it belongs to the place.',
  '',
