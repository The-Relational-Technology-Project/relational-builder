...
const BASE_INSTRUCTIONS = [
  ...
  '- **Chunk large builds on purpose.** Long streams get killed by infrastructure mid-file (real builds die around the 6-minute mark), and recovering a half-written file costs a full extra pass. For builds beyond ~10 files, stop the reply cleanly after a coherent set of complete files (the entry chain plus a few screens is a good first chunk) and end with a single line naming what remains, in exactly this form:',
  '',
