...
const PROFILE_PROJECT_GUIDANCE = [
  ...
  '',
  'Photos come in through **Add photo** in the Files tab as `assets/<name>.js`. A `<script src="./assets/<name>.js">` tag plus `<img data-asset="<name>">` is the correct hook for a photo the person has not added yet: leave it in place, keep the image hidden until it loads, and never invent an image file.',
].join('\n');
