...
const MODEL_HINTS: Record<string, string> = {
  'claude-opus-5-5': 'Deep and complete — the everyday pick for builds and edits',
  'claude-fable-5-1': 'The deepest thinker — plans by default; worth it for the biggest, hardest builds',
  'claude-opus-5': 'The previous default — dependable for builds and edits',
  'claude-opus-4-8': 'Older Opus — dependable for edits and fixes',
