...
export function judgePrompt(ask: string, surfaced: JudgeEntry[], plan: string): string {
  ...
  return [
    ...
    list,
    '',
    'Separately, the assistant\'s own platform provides named services its instructions tell it to recommend — Community Cloud, Supabase, Neon, Resend, Firecrawl, Netlify, Vercel, Community hosting. Recommending any of these is legitimate product guidance, never fabrication.',
    '',
    ...
    ' "fabricated": ["anything the plan cites as if it came from a knowledge base, commons, library, or another neighborhood\'s real project that is NOT in the list — generic suggestions, platform services, and the plan\'s own invented app ideas do NOT count"],',
